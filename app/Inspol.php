...
class Inspol extends Model
{
    ...
    protected $fillable = ['loan_id', 'agent_id', 'county_id', 'crop_id', 'practice', 'harvest_exclusion', 'type', 'unit', 'options', 'ins_level', 'planting_days', 'ins_price', 'ins_share', 'premium', 'exp_yield', 'stax_loss_trigger', 'stax_desired_range', 'stax_protection_factor'];

    /* CASTS */
    protected $casts = [
        'harvest_exclusion' => 'boolean',
        'ins_level' => 'double',
