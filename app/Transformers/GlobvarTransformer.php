...
class GlobvarTransformer extends TransformerAbstract {
    public function transform(Globvar $item)
    {
        ...
        return [
            ...
            'prod_discount_rate' => (double)$item->prod_discount_rate,
            'fsa_assignment_discount_rate' => (double)$item->fsa_assignment_discount_rate,
            'ins_discount_rate' => (double)$item->ins_discount_rate,
            'ins_discount_insoyield' => (double)$item->ins_discount_insoyield,
            'rp_discount_rate' => (double)$item->rp_discount_rate,
            'rphpe_discount_rate' => (double)$item->rphpe_discount_rate,
            'yp_discount_rate' => (double)$item->yp_discount_rate,
            'nonrp_discount_rate' => (double)$item->nonrp_discount_rate,
            'supins_discount_rate' => (double)$item->supins_discount_rate,
