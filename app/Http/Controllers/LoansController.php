...
class LoansController extends ApiController
{
    ...
    {
        // show all
        $records = Loan::with('agents.agency', 'analyst', 'applicants.fins', 'attachments', 'comments.responses.user', 'comments.status', 'comments.user', 'committee.user', 'corps', 'distributor', 'farmers', 'financials', 'joints', 'loantypes', 'location.regions', 'partners', 'quests', 'references', 'status')->get();
