...
class LoansController extends ApiController
{
    ...
    {
        // show all
        $records = Loan::with('agents.agency', 'analyst', 'applicants', 'attachments', 'comments.responses', 'comments.status', 'committee', 'distributor', 'farmers', 'financials', 'loantypes', 'location.regions', 'status')->get();
