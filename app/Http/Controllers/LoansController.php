...
class LoansController extends ApiController
{
    ...
    {
        // show all
        $records = Loan::with('agents.agency', 'analyst', 'applicants', 'attachments', 'comments.responses', 'comments.status', 'comments.user', 'committee.user', 'distributor', 'farmers', 'financials', 'loantypes', 'location.regions', 'quests', 'status')->get();
