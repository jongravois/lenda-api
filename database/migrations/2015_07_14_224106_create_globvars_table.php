...
class CreateGlobvarsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('globvars', function (Blueprint $table) {
            ...
            $table->double('int_percent_arm')->default(12);
            $table->double('int_percent_dist')->default(12);
            ...
            $table->double('prod_discount_rate')->default(50);
            $table->double('fsa_assignment_discount_rate')->default(20);
            $table->double('ins_discount_rate')->default(20);
            $table->double('ins_discount_insoyield')->default(20);
            $table->double('rp_discount_rate')->default(20);
            $table->double('rphpe_discount_rate')->default(20);
            $table->double('yp_discount_rate')->default(20);
            $table->double('nonrp_discount_rate')->default(20);
            $table->double('supins_discount_rate')->default(20);
            $table->double('equipment_discount_rate')->default(50);
            $table->double('realestate_discount_rate')->default(20);
            $table->double('claims_discount_rate')->default(100);
